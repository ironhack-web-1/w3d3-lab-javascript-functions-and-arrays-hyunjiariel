...
function sum(array) {
  ...
  for (let variable of array) {
    if (typeof variable === "number") {
      ...
      accumulator = variable.length + accumulator;
...
console.log(averageNumbers([1,2,3])); //need to call the function to see if it works and then it started working;
...
for (const randomW0rd of wordsUnique) {
  console.log(randomW0rd);
}*/

/*const uniquifyArray = wordsUnique.map(function => {
